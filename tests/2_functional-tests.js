...
suite('Functional Tests', () => {
    test('Solve a puzzle with valid puzzle string: POST request to /api/solve', function(done) {
      ...
      test('Solve a puzzle with invalid characters: POST request to /api/solve', function(done) {
        ...
        .request(server)
        .post('/api/solve')
        .send({ puzzle: "b.5..2.84..63.12.7.2..5.....9..1....8.2.3674.3.7.2..9.47...8..1..16....926914.37." })
        .end(function(err, res){
        assert.equal(res.status, 200);
      ...
      test('Check a puzzle placement with invalid characters: POST request to /api/check', function(done) {
        ...
        .request(server)
        .post('/api/check')
        .send({puzzle: "b.5..2.84..63.12.7.2..5.....9..1....8.2.3674.3.7.2..9.47...8..1..16....926914.37.", coordinate: "A2", value: "1"})
        .end(function(err, res){
        assert.equal(res.status, 200);
        assert.equal(res.body.error, "Invalid characters in puzzle" )
        done();
      ...
      test('Check a puzzle placement with incorrect length: POST request to /api/check', function(done) {
        ...
        .request(server)
        .post('/api/check')
        .send({puzzle: ".5..2.84..63.12.7.2..5.....9..1....8.2.3674.3.7.2..9.47...8..1..16....926914.37.", coordinate: "A2", value: "1"})
        .end(function(err, res){
        assert.equal(res.status, 200);
        assert.equal(res.body.error, "Expected puzzle to be 81 characters long" )
        done();
      ...
      test('Check a puzzle placement with invalid placement coordinate: POST request to /api/check', function(done) {
        ...
        .request(server)
        .post('/api/check')
        .send({puzzle: validPuzzle, coordinate: "z2", value: "1"})
        .end(function(err, res){
        assert.equal(res.status, 200);
      ...
      test('Check a puzzle placement with invalid placement value: POST request to /api/check', function(done) {
        ...
        .request(server)
        .post('/api/check')
        .send({puzzle: validPuzzle, coordinate: "a2", value: "b"})
        .end(function(err, res){
        assert.equal(res.status, 200);
